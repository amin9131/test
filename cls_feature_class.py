...
class FeatureClass:
    def __init__(self, params, is_eval=False):
        ...
        self._aud_dir = os.path.join(self._dataset_dir, self._dataset_combination) # e.g D:dataset/mic_dev.اینجا مسیر دیتاست دولوپ را میسازد.

        self._desc_dir = None if is_eval else os.path.join(self._dataset_dir, 'metadata_dev') #اینجا مسیر metadata_dev را میسازد
