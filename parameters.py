...
def get_params(argv='7'):
    ...
    params = dict(
        ...
        dataset_dir='D:/tutorials/University/AASP/proposal/dataset/SELD - DCASE/2023',

        # OUTPUT PATHS
        # feat_label_dir='DCASE2020_SELD_dataset/feat_label_hnet/',  # Directory to dump extracted features and labels
        feat_label_dir='D:/tutorials/University/AASP/proposal/dataset/SELD - DCASE/2023/seld_feat_label',
